...
describe('matchSync', () => {
  test('matches * route', () => {
    expect(matchSync(routes, '/404')).toEqual([
      {
        params: {},
        parentPathname: '',
        part: undefined,
  ...
  test('matches param subpath', () => {
    expect(matchSync(routes, '/func/val')).toEqual([
      {
        params: {},
        parentPathname: '',
        part: undefined,
  ...
  test('matches route with optional subpath', () => {
    expect(matchSync(routes, '/trees')).toEqual([
      {
        params: {},
        parentPathname: '',
        part: undefined,
  ...
  test('matches route with optional subpath against subpath param', () => {
    expect(matchSync(routes, '/trees/kyle')).toEqual([
      {
        params: {},
        parentPathname: '',
        part: undefined,
